namespace Web1
{
    ...
    [EventSource(Name = "MyCompany-ServiceFabric_Custom_RemotingV2_Serializer_HeaderInject-Web1")]
...
#else
            const int numArgs = 8;
            fixed (char* pServiceName = serviceName, pServiceTypeName = serviceTypeName, pApplicationName = applicationName, pApplicationTypeName = applicationTypeName, pNodeName =
 nodeName, pMessage = message)
            {
